...
const { phoneSchema, loginSchema, otpSchema, registerSchema, refreshTokenSchema, logoutSchema } = require('../validations/auth.validation');
...
router.post('/logout', authenticateToken, validate(logoutSchema), logout);
