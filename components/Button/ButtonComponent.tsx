...
import { TouchableOpacity, Text, StyleSheet, View, Image, ActivityIndicator, ImageSourcePropType } from "react-native";
 ...
 * @param {ImageSourcePropType} rightImg - Path to right image
 * @param {ImageSourcePropType} leftImg - Path to left image
 }}
 */
    ...
    return (
        <TouchableOpacity
            ...
            <View style={styles.contentContainer}>
                {leftImg && <Image source={leftImg} style={styles.img}/>}
                <Text style={buttonTextStyle}>{title}</Text>
                {rightImg && <Image source={rightImg} style={styles.img}/>}
            </View>
        </TouchableOpacity>
    );
};
